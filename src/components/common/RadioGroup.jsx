...
const RadioGroup = ({ mainLabel, radioOne, radioTwo, data }) => {
    ...
    return (
        <div className="radio-group">
            ...
            {radioOne ?
                <label>
                    <input name={mainLabel} type="radio" value={radioOne} onChange={e => updateData(e.target.value)} />
                    {radioOne === 'Single' ? 'Single site' : 'New Zealand'}
                </label>
            :null}
            {radioTwo ?
                <label>
                    <input name={mainLabel} type="radio" value={radioTwo} onChange={e => updateData(e.target.value)} />
